...
export const useProfileByName = (
  name: string,
  params?: { _bookings?: boolean; _venues?: boolean }
) => {
  return useQuery<Profile, Error>({
...
export const useBookingsByProfile = (
  name: string,
  params?: { _venue?: boolean; page?: number; limit?: number; sort?: string }
) => {
